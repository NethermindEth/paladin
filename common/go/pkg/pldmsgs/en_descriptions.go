...
var (
	...
	IndexedTransactionFromChain            = pdm("IndexedTransaction.fromChain", "The sender's chain-neutral address (optional; populated alongside 'from' for non-EVM base ledgers)")
	IndexedTransactionTo                   = pdm("IndexedTransaction.to", "The recipient's Ethereum address (optional)")
	IndexedTransactionToChain              = pdm("IndexedTransaction.toChain", "The recipient's chain-neutral address (optional; populated alongside 'to' for non-EVM base ledgers)")
	...
	IndexedTransactionContractAddressChain = pdm("IndexedTransaction.contractAddressChain", "The chain-neutral address of the contract created by this transaction (optional; populated alongside 'contractAddress' for non-EVM base ledgers)")
	...
	EventWithDataAddressChain              = pdm("EventWithData.addressChain", "The chain-neutral address of the smart contract that emitted this event (optional; populated alongside 'address' for non-EVM base ledgers)")
...
var (
	...
	PublicTxInputPayloadKind               = pdm("PublicTxInput.payloadKind", "Disambiguates the shape of 'data' for base ledgers with more than one payload kind (optional; empty means the base ledger's implicit default kind)")
	...
	PublicTxPayloadKind                    = pdm("PublicTx.payloadKind", "Disambiguates the shape of 'data' for base ledgers with more than one payload kind (optional; empty means the base ledger's implicit default kind)")
...
var (
	...
	BlockchainEventListenerSourceAddressChain               = pdm("BlockchainEventListenerSource.addressChain", "The chain-neutral address to listen for events from (optional; populated alongside 'address' for non-EVM base ledgers)")
...
var (
	...
	PublicTxManagerOrchestratorConfigRestoreConfirmationRetry  = pdm("PublicTxManagerOrchestratorConfig.restoreConfirmationRetry", "Restore-preamble confirmation poll retry configuration (Stellar only)")
