...
type SyncPoints interface {
	...
	PersistDispatchBatch(dCtx components.DomainContext, contractAddress pldtypes.ChainAddress, transactionID uuid.UUID, dispatchBatch *DispatchBatch, stateDistributions []*components.StateDistribution, preparedTxnDistributions []*components.PreparedTransactionWithRefs) error
